...
class TagResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'usage_count' => $this->posts_count ?? 0,
            ...
            'urls' => [
                ...
                'posts' => route('tags.posts', $this->slug),
                'edit' => $this->when(
                    auth()->check() && auth()->user()->hasRole('admin'),
                    route('admin.tags.edit', $this->id)
                ),
            ],
    ...
    public function with($request)
    {
        return [
            'links' => [
                'similar_tags' => route('api.tags.similar', $this->id),
                'trending_posts' => route('api.tags.trending-posts', $this->id),
            ],
        ];
    }
}