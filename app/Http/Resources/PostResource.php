...
class PostResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'content' => $this->when(
                $request->route()->getName() === 'api.posts.show' || $request->get('include_content'),
                $this->content
            ),
            'timeline_json' => $this->when(
                $request->route()->getName() === 'api.posts.show',
            ...
            'seo_meta' => $this->when(
                $request->route()->getName() === 'api.posts.show' && $this->relationLoaded('seoMeta'),
